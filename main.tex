...
\renewcommand{\bibname}{\vspace{-1.0in}\centerline{\large\bf REFERENCES}\vspace{-0.5in}}
...
%    \end{figure}
    ...
    \startabstractpage{TRADING UTILIZATION FOR CIRCUITRY:\\HARDWARE-SOFTWARE CO-DESIGN FOR REAL-TIME SOFTWARE-BASED SHORT-CIRCUIT PROTECTION}{AARON WILLCOCK}{December}{2018}{Dr. Nathan Fisher}{Computer Science}{Master of Science}
    ...
    \autobiographicalstatementpage{I am a Ph.D. candidate in the Wayne State University Department of Computer science pursuing a Ph.D of Computer Science with a minor in Mechanical Engineering.}
